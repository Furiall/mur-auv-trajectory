...
# класс Конфигурации (параметры движения и настройки)
class Config:
    # Параметры движения
    BASE_SPEED = 50
    DEPTH_TARGET = 1.2
...
# класс управления движением (регуляторы, стабилизация, повороты)
...
# класс телеметрии и Логирования (вывод телеметрии и логирование данных)
...
# класс интерфейса пользователя (пользовательский интерфейс и управление программой)
class UserInterface:
